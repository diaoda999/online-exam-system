...
import type { Result, PageData, UserVO, AdminUserVO, UserUpdateRequest } from '../types';
...
export const listUsersForAdmin = (params: { roleCode?: string; status?: number; page?: number; size?: number }) =>
  api.get<Result<PageData<AdminUserVO>>>('/user/admin/list', { params }).then((res) => res.data.data);
